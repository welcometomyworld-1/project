...
def AuthenticateFace():
    ...
    try:
        ...
        # Fallback if cv2.face is not available
        print("cv2.face not found, trying alternative...")
        try:
            recognizer = cv2.LBPHFaceRecognizer_create()
        except:
            speak("Face recognition module missing. Please install opencv-contrib-python")
            return 0
